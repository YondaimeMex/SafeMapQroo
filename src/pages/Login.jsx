            ...
            <div className="flex h-full">
                ...
                <section className="bg-white-500 w-screen h-screen">
                    ...
                    <form className="grid grid-cols-1 grid-rows-3 mx-30 my-10">
                        <input className="my-3 py-2 bg-white-100 bg-white-100 border-b border-pink-950 rounded-md pl-2  placeholder:text-pink-800  focus:border-pink-800 focus:ring focus:ring-pink-700 outline-none" type="text" placeholder="Correo electrónico" />
                        <input className="my-3 py-2 bg-white rounded-md pl-2 border-b border-pink-950 placeholder:text-pink-800 focus:border-pink-800 focus:ring focus:ring-pink-700 outline-none" type="password" placeholder="Contraseña" />
                        ...
                        <div className="flex mx-20">
                            <p className="text-.2">¿Aún no tienes una cuenta?</p>
                            <a href="#" className="text-pink-800">Registrate</a>
                        </div>
                    </form>
                </section>
            </div>
